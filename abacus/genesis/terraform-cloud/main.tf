# Adapted from
# https://github.com/hashicorp/terraform-dynamic-credentials-setup-examples/blob/5308cd970c0832f2180d7eb1e645dea33c4e344c/aws/tfc-workspace.tf

provider "tfe" {
  # TODO I don't think this should be a variable.
